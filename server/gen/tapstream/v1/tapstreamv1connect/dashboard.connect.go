...
package tapstreamv1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/adityabansal/tapstream/server/gen/tapstream/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	DashboardServiceName = "tapstream.v1.DashboardService"
)
...
// period.
const (
	// DashboardServiceSubscribeUpdatesProcedure is the fully-qualified name of the DashboardService's
	// SubscribeUpdates RPC.
	DashboardServiceSubscribeUpdatesProcedure = "/tapstream.v1.DashboardService/SubscribeUpdates"
)

// DashboardServiceClient is a client for the tapstream.v1.DashboardService service.
...
// DashboardServiceHandler is an implementation of the tapstream.v1.DashboardService service.
...
func NewDashboardServiceHandler(svc DashboardServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	dashboardServiceMethods := v1.File_tapstream_v1_dashboard_proto.Services().ByName("DashboardService").Methods()
	dashboardServiceSubscribeUpdatesHandler := connect.NewServerStreamHandler(
		DashboardServiceSubscribeUpdatesProcedure,
		svc.SubscribeUpdates,
		connect.WithSchema(dashboardServiceMethods.ByName("SubscribeUpdates")),
		connect.WithHandlerOptions(opts...),
	)
	return "/tapstream.v1.DashboardService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case DashboardServiceSubscribeUpdatesProcedure:
			dashboardServiceSubscribeUpdatesHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
